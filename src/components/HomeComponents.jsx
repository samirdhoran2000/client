...
const menuItems = [
  {
    ...
    subItems: [
      { title: "Multi Jet Fusion", href: "/3d-printing/hp-multi-jet-fusion" },
      {
        ...
        href: "/3d-printing/sla-stereolithograpy-3d-printing-services",
      },
      {
        title: "Fused Deposition Modeling (FDM) 3D Printing",
        href: "/3d-printing/filament-fdm-guidelines",
      },
      {
  ...
  },
  {
    ...
    subItems: [
      ...
      },
      {
        ...
        href: "/reverse-engineering-3d-scanning",
      },
      {
    ...
    <header>
        ...
        <div className="flex space-x-4">
          <span className="text-black">
            <a href="tel:503-943-2781">
              Call: <b>503-943-2781</b>
            </a>
          </span>
          <span className="text-black">
            <a href="mailto:info@rapidmade.com">
              Email: <b>info@rapidmade.com</b>
            </a>
          </span>
        </div>
        <button
      ...
      >
        <div className="container mx-auto flex items-center justify-between py-4">
          ...
          <Link to="/">
            <img
              src="https://cdn-hnohh.nitrocdn.com/ocjBvGnJhUOWxancuUtcYLluFwYBZCbU/assets/images/optimized/rev-92d29a4/rapidmade.com/wp-content/uploads/2018/07/RapidMadeLogo.png"
              alt="RapidMade"
              className="h-10"
            />
          </Link>
...
const HeroSection = () => {
  return (
    <section className="relative min-h-[100vh] flex items-center justify-end">
      <div className="absolute inset-0">
        <iframe
          src="https://www.youtube.com/embed/K3yAMbTLzJ8?controls=0&rel=0&playsinline=1&cc_load_policy=0&enablejsapi=1&origin=https%3A%2F%2Frapidmade.com&widgetid=1"
          frameBorder="0"
          allowFullScreen
...
const industries = [
  ...
  { title: 'Electronics', href: 'https://rapidmade.com/electronics-manufacturing/' },
  { title: 'Industrial', href: 'https://rapidmade.com/industrial-manufacturing/' },
...
const socialMedia = [
  { name: 'Facebook', href: 'https://www.facebook.com/RapidMade-150412631725702', icon: Facebook },
  { name: 'LinkedIn', href: 'https://www.linkedin.com/company/rapidmade', icon: Linkedin },
